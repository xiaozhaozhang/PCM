...
<body class="templatemo-bg-gray">
	<div class="container">
		<div class="col-md-12">
			<h1 class="margin-bottom-15">生产管理系统</h1><!-- 馆际互借平台-学生子系统 -->
		        ...
		        <div class="form-group">
		          <div class="col-xs-12">		            
		            <div class="control-wrapper">
		            	...
		            	<input type="text" class="form-control" id="username" placeholder="Username" value="admin" name="urAccess">
		            </div>		            	            
		          </div>              
		        </div>
		        <div class="form-group">
		          <div class="col-md-12">
		          	<div class="control-wrapper">
		            	...
		            	<input type="password" class="form-control" id="password" placeholder="Password" value="123" name="urPsd">
		            </div>
		          </div>
		        </div>
		        <div class="form-group">
...
var data=$("#fromId").serialize();
 $.ajax({
  ...
  window.location.href="<%=path%>/book/list.do";
