...
<body class="templatemo-bg-gray">
	...
	<div class="container">
		<div class="col-md-12">			
			<form class="form-horizontal templatemo-create-account templatemo-container" role="form" action="<%=path%>/user/register.do" method="post"> <!-- /register.do -->
				<div class="form-inner">
			        ...
			        <div class="form-group">
				        ...
				        <div class="form-group">
							 <div class="col-md-12">
							   <input type="submit" name="createId" value="createId" class="btn btn-info">
							</div>
				        </div>	
				</div>				    	
		      </form>		      
